...
//                           +-\/-+
//                     VCC  1|    |14  GND
//     SCK <-> (D 10)  PB0  2|    |13  AREF (D  0) PA <-> MISO
//    MOSI <-> (D  9)  PB1  3|    |12  PA1  (D  1) 
//                     PB3  4|    |11  PA2  (D  2) 
//  PWM CE <-> (D  8)  PB2  5|    |10  PA3  (D  3) 
//  PWM CS <-> (D  7)  PA7  6|    |9   PA4  (D  4) 
...
#define SOFT_SPI_MOSI_PIN 9
#endif

#ifndef SOFT_SPI_SCK_PIN
#define SOFT_SPI_SCK_PIN 10
#endif
